...
Your Brick **pyrealsense** is ready!

Custom Bricks are modular components that add reusable functionality to your app.

## How to use it

Write your Python class inside `bricks/pyrealsense/__init__.py` and add the `@brick` decorator.
```python
# bricks/pyrealsense/__init__.py
...
your brick is created under the `bricks/pyrealsense` folder that contains the following files:
